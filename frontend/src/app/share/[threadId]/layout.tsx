...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Quriosity Q',
    description: 'Replay this Agent conversation on Quriosity Q',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Quriosity Q';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Quriosity Q';
